...
// -- SVG Icon components (no emoji, renders everywhere) -----------------------
function FeatureIcon(props) {
  var id = props.id;
  var c = "#C9A84C";
  var s = {display:"block",marginBottom:14,flexShrink:0};
  if (id === "scan") return React.createElement("svg",{width:36,height:36,viewBox:"0 0 24 24",fill:"none",style:s},
  ...
  if (id === "brain") return React.createElement("svg",{width:36,height:36,viewBox:"0 0 24 24",fill:"none",style:s},
    React.createElement("path",{d:"M12 4C9 4 7 6 7 8.5c0 1.5.6 2.8 1.5 3.5L7 15h10l-1.5-3c.9-.7 1.5-2 1.5-3.5C17 6 15 4 12 4z",stroke:c,strokeWidth:"1.6",strokeLinejoin:"round"}),
    React.createElement("path",{d:"M9.5 8.5h.01M14.5 8.5h.01",stroke:c,strokeWidth:"2",strokeLinecap:"round"}));
  if (id === "map") return React.createElement("svg",{width:36,height:36,viewBox:"0 0 24 24",fill:"none",style:s},
    React.createElement("path",{d:"M3 6l6-3 6 3 6-3v15l-6 3-6-3-6 3V6z",stroke:c,strokeWidth:"1.8",strokeLinejoin:"round"}),
    React.createElement("path",{d:"M9 3v15M15 6v15",stroke:c,strokeWidth:"1.8"}));
  if (id === "pin") return React.createElement("svg",{width:36,height:36,viewBox:"0 0 24 24",fill:"none",style:s},
    React.createElement("path",{d:"M21 10c0 7-9 13-9 13s-9-6-9-13a9 9 0 0118 0z",stroke:c,strokeWidth:"1.8"}),
    React.createElement("circle",{cx:"12",cy:"10",r:"3",stroke:c,strokeWidth:"1.8"}));
  return React.createElement("div",{style:{width:36,height:36,marginBottom:14}});
}
function UploadIcon(props) {
  var i = props.i;
  var col = i === 0 ? "#C9A84C" : "#3B82F6";
  var bg  = i === 0 ? "rgba(201,168,76,.1)" : "rgba(59,130,246,.1)";
  var bd  = i === 0 ? "rgba(201,168,76,.2)" : "rgba(59,130,246,.2)";
  var svg = props.id === "gallery"
    ? React.createElement("svg",{width:24,height:24,viewBox:"0 0 24 24",fill:"none"},
        React.createElement("rect",{x:"3",y:"3",width:"18",height:"18",rx:"3",stroke:col,strokeWidth:"1.8"}),
        React.createElement("circle",{cx:"8.5",cy:"8.5",r:"1.5",stroke:col,strokeWidth:"1.5"}),
        React.createElement("path",{d:"M21 15l-5-5L5 21",stroke:col,strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"}))
    : React.createElement("svg",{width:24,height:24,viewBox:"0 0 24 24",fill:"none"},
        React.createElement("path",{d:"M23 19a2 2 0 01-2 2H3a2 2 0 01-2-2V8a2 2 0 012-2h4l2-3h6l2 3h4a2 2 0 012 2z",stroke:col,strokeWidth:"1.8",strokeLinejoin:"round"}),
        React.createElement("circle",{cx:"12",cy:"13",r:"4",stroke:col,strokeWidth:"1.8"}));
  return React.createElement("div",{style:{width:48,height:48,borderRadius:8,background:bg,border:"1px solid "+bd,display:"flex",alignItems:"center",justifyContent:"center",flexShrink:0}},svg);
}
...
function HomeScreen(props){
  ...
  var FEATS=[
    {icon:"scan",en:"100% Document Coverage",ar:"تغطية كاملة للوثيقة",sub:"Every mark, code, and note extracted from your inspection sheet",subAr:"كل علامة وكود وملاحظة من ورقة الفحص"},
    {icon:"brain",en:"AI-Powered Analysis",ar:"تحليل بالذكاء الاصطناعي",sub:"Claude AI diagnoses every fault with repair steps and cost estimates",subAr:"ذكاء اصطناعي يشخص كل عطل مع خطوات الإصلاح والتكلفة"},
    {icon:"map",en:"Visual Fault Mapping",ar:"خريطة الأعطال المرئية",sub:"See each fault pinpointed on an interactive vehicle schematic",subAr:"شاهد كل عطل على مخطط السيارة"},
    {icon:"pin",en:"Verified Garage Network",ar:"شبكة ورش معتمدة",sub:"Find trusted service centers in Qatar and across the GCC",subAr:"اعثر على مراكز خدمة موثوقة"},
  ];
      ...
      React.createElement("div",{style:{display:"grid",gridTemplateColumns:"repeat(auto-fit,minmax(240px,1fr))",gap:2,background:T.bd,borderRadius:8,overflow:"hidden",border:"1px solid "+T.bd}},
        FEATS.map(function(f,i){
          return React.createElement(SR,{key:f.en,d:i*80,s:{background:T.bg2,padding:28,transition:"background .2s"},className:"card-lift"},
            React.createElement(FeatureIcon,{id:f.icon}),
...
function ScanScreen(props){
  ...
  return React.createElement("div",{style:Object.assign({},WRP,{paddingTop:32})},
    ...
    step==="choose"&&React.createElement("div",null,
      ...
      [{icon:"gallery",en:"Upload from Gallery",ar:"رفع من معرض الصور",sub:ar?"اختر صورة موجودة في هاتفك":"Select an existing photo from your phone",click:function(){if(galRef.current)galRef.current.click();}},{icon:"camera",en:"Capture with Camera",ar:"التقاط بالكاميرا",sub:ar?"افتح الكاميرا والتقط صورة":"Open camera and take a photo now",click:function(){setStep("camera");}}].map(function(opt,i){
        return React.createElement("button",{key:i,onClick:opt.click,className:"card-lift",style:{width:"100%",background:T.bg2,border:"1px solid "+T.bd,borderRadius:8,padding:"22px 20px",display:"flex",alignItems:"center",gap:16,marginBottom:12,cursor:"pointer",textAlign:"left",transition:"all .22s"}},
          React.createElement(UploadIcon,{id:opt.icon,i:i}),
          React.createElement("div",null,
...
function ReportScreen(props){
  ...
  if(faults.length===0)return React.createElement("div",{style:{minHeight:"calc(100vh - 98px)",background:T.bg0,display:"flex",flexDirection:"column",alignItems:"center",justifyContent:"center",padding:48,gap:14,textAlign:"center"}},
    React.createElement("div",{style:{width:64,height:64,borderRadius:8,background:T.bg2,border:"1px solid "+T.bd,display:"flex",alignItems:"center",justifyContent:"center",fontSize:28,marginBottom:8}},React.createElement("svg",{width:28,height:28,viewBox:"0 0 24 24",fill:"none"},React.createElement("rect",{x:"4",y:"3",width:"16",height:"18",rx:"2",stroke:"#3D5468",strokeWidth:"1.8"}),React.createElement("path",{d:"M8 8h8M8 12h8M8 16h5",stroke:"#3D5468",strokeWidth:"1.8",strokeLinecap:"round"}))),
            ...
            React.createElement("div",{style:{display:"flex",justifyContent:"space-between",alignItems:"flex-start",marginBottom:10}},
              React.createElement("div",null,
                ...
                React.createElement("div",{style:{display:"flex",alignItems:"center",gap:5}},
                  React.createElement("svg",{width:12,height:12,viewBox:"0 0 24 24",fill:T.gold,style:{flexShrink:0}},React.createElement("polygon",{points:"12,2 15.09,8.26 22,9.27 17,14.14 18.18,21.02 12,17.77 5.82,21.02 7,14.14 2,9.27 8.91,8.26"})),
  ...
  return React.createElement("div",{style:{minHeight:"calc(100vh - 98px)",background:T.bg0}},
    ...
    React.createElement("div",{style:{maxWidth:640,margin:"0 auto",padding:"20px 24px 60px"}},
      ...
      React.createElement("div",{style:{background:T.bg2,borderRadius:8,border:"1px solid "+T.bd,padding:18,marginBottom:10}},
        ...
        React.createElement("div",{style:{fontSize:12,color:T.t2,lineHeight:1.7,marginBottom:12}},ar?"Safari: اضغط زر المشاركة \u2B06 ثم إضافة إلى الشاشة الرئيسية":"In Safari: Tap Share \u2B06 then Add to Home Screen"),
